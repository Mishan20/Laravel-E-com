        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="{{ route('cart') }}" class="relative text-gray-600 hover:text-gray-800">
                    ...
                    <span class="absolute inline-flex items-center justify-center px-2 py-1 text-xs font-bold text-white bg-green-500 rounded-full -top-1 -right-5">{{ count(session('cart', [])) }}</span>
                </a>
            </div>
            @endhasrole
