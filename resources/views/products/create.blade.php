            ...
            <div class="bg-white shadow-sm overflow-hiden sm:rounded-lg">
                ...
                <div class="sm:flex sm:items-center">
                        <div class="mt-4 mb-4 sm:ml-2 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ url('/products') }}" class="block px-3 py-2 text-sm font-semibold text-white bg-blue-500 rounded-md shadow-sm text-end hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ __('Product List') }}</a>
                        </div>
                    </div>
                </div>
